      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <section className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Shapes accordion */}
            <div className={`glass-panel border-neutral-800 rounded-xl glow-pink transition-all relative ${activeAccordion === "shapes" ? "overflow-visible z-20" : "overflow-hidden z-0"}`}>
              <button
            ...
            {/* Colors Accordion */}
            <div className={`glass-panel border-neutral-800 rounded-xl glow-pink transition-all relative ${activeAccordion === "colors" ? "overflow-visible z-20" : "overflow-hidden z-0"}`}>
              <button
            ...
            {/* Logo accordion */}
            <div className={`glass-panel border-neutral-800 rounded-xl glow-pink transition-all relative ${activeAccordion === "logo" ? "overflow-visible z-20" : "overflow-hidden z-0"}`}>
              <button
